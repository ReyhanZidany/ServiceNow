    ...
    <main>
        <div class="container mx-auto mt-8">
            <section class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Welcome to TicketMaster - ServiceDesk</h1>
            ...
            <section class="mt-8 bg-white shadow rounded-lg p-6">
                <!-- Isi konten dashboard untuk ServiceDesk -->
            </section>
        </div>
    </main>
</body>
